...
namespace PS2GradingTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        public void removalTest()
        {
            ...
            t.RemoveDependency("a", "b");
            HashSet<String> aPends = new HashSet<string>(t.GetDependents("a"));
            Assert.IsTrue(aPends.SetEquals(new HashSet<string>() { "c" }));
            aPends = new HashSet<string>(t.GetDependees("b"));
            Assert.IsTrue(aPends.SetEquals(new HashSet<string>() { }));
        }
        /// <summary>
        ///Makes sure it is not adding duplicates
        ///</summary>
        [TestMethod()]
        ...
        /// <summary>
        ///Test for private data (provided by TA on forum)
        ///</summary>
